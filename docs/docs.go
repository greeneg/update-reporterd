    ...
    "paths": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/model.OSFamily"
                            }
                        }
                    },
                    "400": {
        ...
        "/pkg/archid/{pkgArchId}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "Package Architecture Id",
                        "name": "pkgArchId",
                        "in": "path",
                        "required": true
                    }
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/model.PackageByVersionName"
                            }
                        }
                    },
                    "400": {
        ...
        "/pkg/platformid/{pkgPlatformId}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "Package Platform Id",
                        "name": "pkgPlatformId",
                        "in": "path",
                        "required": true
                    }
        ...
        "/pkg/type/{pkgType}": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/model.PackageType"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Package Type object",
                        "name": "pkgType",
                        "in": "body",
                        "required": true,
                        "schema": {
